...
export const getSuggestedBindingsForArrows = (
  ...
  return (
    selectedElements
      ...
      // Filter out frame elements so they don't get the binding highlight
...
const determineFocusPoint = (
  ...
  switch (element.type) {
    ...
    case "magicframe":
    case "ellipse":
      point = findFocusPointForEllipse(element as ExcalidrawEllipseElement, focus, adjecentPointRel);
      break;
  }
